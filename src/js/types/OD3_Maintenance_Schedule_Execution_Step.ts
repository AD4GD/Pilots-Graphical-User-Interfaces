...
type OD3_Maintenance_Schedule_Execution = Parse.Object;
type OD3_Tenant = Parse.Object;

export interface OD3_Maintenance_Schedule_Execution_StepAttributes {
  id: string;
  objectId: string;
  createdAt: Date;
  updatedAt: Date;
  ...
  schedule: OD3_Maintenance_Schedule_Execution;
  tenant?: OD3_Tenant;
  type?: string;
  usedmaterial?: string;
}

export class OD3_Maintenance_Schedule_Execution_Step extends Parse.Object<OD3_Maintenance_Schedule_Execution_StepAttributes> {
  static className: string = "OD3_Maintenance_Schedule_Execution_Step";

  constructor(data?: Partial<OD3_Maintenance_Schedule_Execution_StepAttributes>) {
    super("OD3_Maintenance_Schedule_Execution_Step", data as OD3_Maintenance_Schedule_Execution_StepAttributes);
  }
  ...
  get schedule(): OD3_Maintenance_Schedule_Execution {
    return super.get("schedule");
  }
  set schedule(value: OD3_Maintenance_Schedule_Execution) {
...
Parse.Object.registerSubclass("OD3_Maintenance_Schedule_Execution_Step", OD3_Maintenance_Schedule_Execution_Step);
